<div class="container">
        <div class="row">
                    ...
                    <div class="row intro">
                        <div class="col">
                            <div class="card card__custom">
                                ...
                                <div class="card-body">
                                    <a href="#" class="card-text">Lời chào mừng</a>
                                </div>
                            </div>
                            <div class="card card__custom">
                                <img src="./images/c2.jpg" class="card-img-top" alt="...">
                                <div class="card-body">
                                    <a href="#" class="card-text">Nghiên cứu khoa học</a>
                                </div>
                            </div>
                        </div>
                        <div class="col">
                            <div class="card card__custom">
                                ...
                                <div class="card-body">
                                    <a href="#" class="card-text">Giảng viên</a>
                                </div>
                            </div>
                            <div class="card card__custom">
                                <img src="./images/c4.jpg" class="card-img-top" alt="...">
                                <div class="card-body">
                                    <a href="#" class="card-text">Đào Tạo</a>
                                </div>
                            </div>
                        </div>
                        <div class="col">
                            <div class="card card__custom-last">
                                <img src="./images/c5.jpg" class="card-img-top" alt="...">
                                <div class="card-body">
                                    <a href="#" class="card-text">Ảnh Khoa CNTT</a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-3 facebook__custom">
                <div class="fb-page " data-href="https://www.facebook.com/daihocthuyloi1959" data-tabs="" data-width="200" data-height="200" data-small-header="false" data-adapt-container-width="false" data-hide-cover="false" data-show-facepile="false">
